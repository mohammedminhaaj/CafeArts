    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ProfileUpdateSuccess ? "Profile has been updated successfully."
                : "";
            ...
            var model = new IndexViewModel
            {
                ...
                Orders = _context.orders.Where(m => m.MemberID == userId),
                CartItems = _context.Carts.Include(m => m.Product).Include(m => m.Orders).Where(m => m.MemberID == userId && !m.IsActive)
        };
        ...
        public ActionResult EditProfile([Bind(Include ="Id,FirstName,LastName")]ApplicationUser model)
        {
            if (!ModelState.IsValid)
            {
                var viewmodel = new ApplicationUser() { FirstName = model.FirstName, LastName = model.LastName };
